...
<body>
	...
	<table align ="center" width="800" cellspacing="0" cellpadding ="0" style="background-color: rgb(230,168,0); border-spacing: 0px">
		<tr>
			<td height="200" align="center"><a href="index.py"><img src="../images/giphy2.gif" alt="banner" width="780" height="200" border="0" /></td>
		</tr>
	</table>
	...
	<td>
		...
		<h1>What is <strong style="font-size: 30px; letter-spacing: -2px">BeerMe</strong> all about?</h1>
	...
	<p>Those 21 years of age and over will have access to a straightforward application that gives an instant and personal recommendation for what types of beer would best fit his/her given situation, based on his/her input.</p>
	</td>
